...
- **📖 지능형 도움말 시스템**: "Deep Dive" 가이드가 포함된 다층적 도움말 모달과 전체 **시스템 상세 문서** 페이지를 제공합니다.
- **🌍 다국어 지원**: 모든 안내와 문서에 대해 **한국어**와 **영어**를 자유롭게 전환하며 사용할 수 있습니다.
- **⚡ 속도 조절**: 0.25배속부터 4배속까지 애니메이션 재생 속도를 실시간으로 조절할 수 있습니다.
- **🎨 프리미엄 비주얼**: 네온 포인트, 글래스모피즘, 그리고 Framer Motion을 활용한 부드러운 애니메이션 UI를 제공합니다.
...
### ✅ 제어 흐름 및 이진 탐색 트리 (BST)
```cpp
tree<int> t; // 또는 bst<int> t;
