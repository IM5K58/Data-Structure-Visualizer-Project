        ...
        structures: [
            {
                ...
                howToUse: "Use `std::stack<int> s;` to declare. Include `<stack>` header.",
                codeExample: "#include <stack>\nstack<int> s;\ns.push(10);\ns.push(20);\ns.pop();",
                deepDive: {
            ...
            },
            {
                ...
                howToUse: "Use `std::queue<int> q;` to declare. Include `<queue>` header.",
                codeExample: "#include <queue>\nqueue<int> q;\nq.push(10);\nq.push(20);\nq.pop();",
                deepDive: {
            ...
            },
            {
                ...
                name: "Linked List",
                icon: "🔗",
                description: "A linear collection of data elements whose order is defined by pointers in memory.",
                howToUse: "Define a `struct Node { T data; Node* next; };` and use `new Node()`.",
                codeExample: "struct Node { int data; Node* next; };\nNode* head = new Node();\nhead->data = 10;\nhead->next = new Node();",
                deepDive: {
            ...
            },
            {
                ...
                name: "Tree (BST)",
                icon: "🌳",
                description: "A hierarchical data structure where each node has at most two children. The engine visualizes the recursive structure via pointers.",
                howToUse: "Define a `struct TreeNode { T val; TreeNode *left, *right; };`.",
                codeExample: "struct Node { int val; Node *left, *right; };\nNode* root = new Node{20, nullptr, nullptr};",
                deepDive: {
